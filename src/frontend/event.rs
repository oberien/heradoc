...
use crate::resolve::{Command, Include as ResolvedInclude, ResolveSecurity};
...
pub enum Event<'a> {
    ...
    /// An include generated by an internal frontend, to simulate file inclusion.
    SyntheticInclude(ResolvedInclude, Include<'a>, Cow<'a, str>),
    Label(Cow<'a, str>),
    SoftBreak,
    HardBreak,
    PageBreak,
