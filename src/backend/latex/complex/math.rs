...
impl<'a> CodeGenUnit<'a, ()> for InlineMathGen {
    fn new(
        _cfg: &Config, _tag: (), gen: &mut PrimitiveGenerator<'a, impl Backend<'a>, impl Write>,
    ) -> Result<Self> {
    ...
    fn finish(
        self, gen: &'_ mut PrimitiveGenerator<'a, impl Backend<'a>, impl Write>,
