...
impl<'a, B: Backend<'a>, W: Write> Generator<'a, B, W> {
    ...
    /// An offset is added to all headers generated by this generator.
    /// Don't edit this after you've already retrieved events as it might lead to mismatching start
    /// and end tags, and subsequent failure.
    pub fn adjust_header_levels(&mut self, offset: i32) {
        self.header_level_adjustment = offset;
    }
